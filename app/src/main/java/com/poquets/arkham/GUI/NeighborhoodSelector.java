...
import com.poquets.arkham.Neighborhood;
import com.poquets.arkham.NeighborhoodCursor;
        ...
        mAdapter.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
            public boolean setViewValue(View view, final Cursor cursor, int columnIndex) {
            	...
            	if(columnIndex == 1 || columnIndex == 2) {
            		...
            		if(butBmp != null)
            		{
            			                                but.setBackground(new BitmapDrawable(getResources(), butBmp));
            		}
            		else
            		{
            		...
            		but.setOnClickListener(new OnClickListener()
            		{
						...
						public void onClick(View arg0) {
							if (nei == null) {
								Log.e("Neighborhood", "Neighborhood is null!");
								return;
							}
							
							Log.i("Neighborhood", "Neighborhood Clicked: " + nei.toString() + " (ID: " + nei.getID() + ")");
